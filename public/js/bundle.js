...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2lsdmVyZGV2IiwiYSI6ImNrcHkxYTdvODB5dTcycHAyeHV5MnFhZ24ifQ.W5-HEWbzFIr6g0IvB9eT3A';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends to map bound to include current location
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error in logging out! Try again!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:8000/api/v1/users/".concat(type === 'data' ? 'updateMe' : 'updatePassword'),
              data: data
            });
...
var stripe = Stripe('pk_test_51J3eJdSJ2bOiWHFCVoxSqrpIcYUW1EINXZAtKyEWvC3PYLCf01etXrMYoZqgCfuLHg0TmZkY8zPqTlMXKCgzlHnt00bTMX3nGL');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create checkout form + charge from credit cart
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    console.log('photo', document.getElementById('photo'));
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var oldPassword, newPassword, newPasswordConform;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              newPasswordConform = document.getElementById('password-confirm').value;
              _context.next = 7;
              return (0, _updateSettings.updateSettings)({
                oldPassword: oldPassword,
                newPassword: newPassword,
                newPasswordConform: newPasswordConform
              }, 'password');
